...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.colorconvert.ColorConvertDescriptor.create(testImage,
            colorModel, null);*/
        } else {
            image = ColorConvertDescriptor.create(testImage, colorModel, roi, range, null, null);
        }
