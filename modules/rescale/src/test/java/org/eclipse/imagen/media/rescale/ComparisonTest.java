...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.rescale.RescaleDescriptor.create(testImage, scales,
            offsets, null);*/
        } else {
            image = RescaleDescriptor.create(testImage, scales, offsets, roi, range, false, destNoData, null);
        }
