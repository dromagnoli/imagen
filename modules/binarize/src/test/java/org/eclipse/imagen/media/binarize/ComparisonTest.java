...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.binarize.BinarizeDescriptor.create(testImage,
            THRESHOLDS[dataType], null);*/
        } else {
            image = BinarizeDescriptor.create(testImage, THRESHOLDS[dataType], roi, range, null);
        }
