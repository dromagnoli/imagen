...
public class ComparisonTest extends ComparisonTestBase {
    ...
    protected boolean supportDataType(int dataType) {
        if (dataType == DataBuffer.TYPE_SHORT
                ...
                || dataType == DataBuffer.TYPE_DOUBLE) return false;
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.lookup.LookupDescriptor.create(testImage,
            tableJai, null);*/
        } else {
            image = LookupDescriptor.create(testImage, table, destinationNoDataValue, null, rangeND, false, null);
        }
