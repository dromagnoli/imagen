...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.bandcombine.BandCombineDescriptor.create(testImage, matrix,
            null);*/
        } else {
            image = BandCombineDescriptor.create(testImage, matrix, roi, range, destinationNoData, null);
        }
