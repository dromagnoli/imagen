...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testTranslation() {
        ...
        if (OLD_DESCRIPTOR) {
            /*
            Interpolation interpolation = new org.eclipse.imagen.InterpolationNearest();
            image = org.eclipse.imagen.media.translate.TranslateDescriptor.create(testImage, transX,
                    transY, interpolation, null);*/
        } else {
