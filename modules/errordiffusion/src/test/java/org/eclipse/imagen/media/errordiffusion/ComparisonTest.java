...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.errordiffusion.ErrorDiffusionDescriptor.create(testImage,
            lut, kernel, null);*/
        } else {
            image = ErrorDiffusionDescriptor.create(testImage, lut, kernel, roi, range, null, null);
        }
