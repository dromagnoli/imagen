...
public class ComparisonTest extends ComparisonTestBase {
    ...
    public void testOperation(int dataType, TestSelection testType) {
        ...
        if (OLD_DESCRIPTOR) {
            /*image = org.eclipse.imagen.media.orderdither.OrderedDitherDescriptor.create(testImage,
            colorMap, ditherMask, null);*/
        } else {
            image = OrderedDitherDescriptor.create(testImage, colorMap, ditherMask, null, roi, range, 100d);
        }
